...
- **🚧 Pendente (2026-07-05) — ativar a branch protection da `main` (ADR 11):** passo manual único no painel do GitHub, com o passo a passo completo em `docs/07-deploy/01-ambientes-e-pipeline.md`, seção 8. **Ordem importa:** ativar só depois de os dois workflows (CI e E2E) terem rodado ao menos uma vez cada, senão os nomes dos checks não aparecem na busca do painel. Até a ativação, o fluxo via PR vale como disciplina combinada, não como trava.
